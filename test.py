...
# Tạo một hộp thoại để chọn tệp
root = tk.Tk()
root.withdraw()
file_path = filedialog.askopenfilename(initialdir="data/image", title="Chọn ảnh", filetypes=(("Image files", "*.png;*.jpeg;*.jpg;*.gif;*.bmp"), ("all files", "*.*")))
